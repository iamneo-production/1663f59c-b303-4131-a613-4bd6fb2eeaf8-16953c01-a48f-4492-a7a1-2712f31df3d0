...
(async () => {
  ...
  await page.goto('https://8080-bcbcafcdfbebbedffaceaeddacafaafdfd.project.examly.io');
  ...
  await page1.goto('https://8081-bcbcafcdfbebbedffaceaeddacafaafdfd.project.examly.io');
